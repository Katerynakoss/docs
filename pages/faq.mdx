...
#### Как я могу работать в сети Mina? 
...
1. Блок-продюсер (block producer) - это аналог "майнера" в Биткоин-сети или "валидатора" в других PoS-сетях. Если вы осуществляете стейкинг в Mina, вас могут выбрать для выполнения функции по созданию блоков и получения вознаграждения за подтверждение блоков. 
...
#### Хочу попробовать участвовать в тестовой сети. Где это сделать? 
