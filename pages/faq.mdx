...
#### Необходимо ли мне специальное оборудование?
...
#### Что я могу выполнять в сети Mina? 

Каждая нода может отправлять и получать транзакции в сети Mina. Более того, любая нода может быть "оператором нод". Операторы нод выполняют две определенные роли: 
